...
// create a module
export default angular.module(name, [angularMeteor, uiRouter, PartyAdd, utilsPagination, PartiesSort, PartyRemove, PartyCreator, PartyRsvp, PartyRsvpsList, PartyAddButton, DisplayFlashCard]).component(name, {
    templateUrl: `imports/ui/components/fcList/${ name }/${ name }.html`,
    controllerAs: name,
    controller: PartiesList
});

//# sourceMappingURL=fcListsList-compiled.js.map